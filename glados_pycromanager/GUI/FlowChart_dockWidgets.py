...
from glados_pycromanager.autonomous.executor import (
    FlowchartExecutorMixin,
    WorkerSignals,
    generalNodzCallActionWorker,
)
...
class GladosNodzFlowChart_dockWidget(FlowchartExecutorMixin, NodzMain.Nodz):
    ...
    #region NodzFlowChart Node-specific — moved to FlowchartExecutorMixin (Phase 8.4)
    #endregion
    
    #region NodzFlowChart runs — moved to FlowchartExecutorMixin (Phase 8.4)
    #endregion
...
#region NodzWorkers — moved to glados_pycromanager.autonomous.executor (Phase 8.4)
#endregion
