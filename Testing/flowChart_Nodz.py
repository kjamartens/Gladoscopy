...
# Node A
nodeA = nodz.createNode(name='nodeA', preset='node_preset_1', position=QtCore.QPoint(1010,1010))
...
# # Node B
nodeB = nodz.createNode(name='nodeB', preset='node_preset_1',position=QtCore.QPoint(700,1010))
...
# Node C
nodeC = nodz.createNode(name='nodeC', preset='node_preset_1',position=QtCore.QPoint(1500,1010))
